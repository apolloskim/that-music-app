...
const NavbarNav = (props) => {
  ...
  return (
    <div className="navBar-expand">
      <Link to="/app/browse/featured" className="navBar-header-link">
      ...
      <ul>
        <li className="navBar-group">
          <div className="navBar-item link-subtle">
            <NavLink to="/app/search" activeClassName="active-nav-link" className="link-subtle">
        ...
        <li className="navBar-group">
          <div className="navBar-item">
            <NavLink to="/app/browse/featured" activeClassName="active-nav-link" className="link-subtle">
        ...
        <li className="navBar-group">
          <div className="navBar-item link-subtle">
            <NavLink to="/app/collection/playlists" activeClassName="active-nav-link" className="link-subtle">
      ...
      <div className="session-info">
        <NavLink to="/app/settings/account" activeClassName="active-nav-link" className="session-info-container">
